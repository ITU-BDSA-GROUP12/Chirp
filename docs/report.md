...
For a more indepth visualization of which classes reside in which of the packages mentioned, see the png-file located at 'Chirp/docs/images/PackageDiagram.drawio.png', a complete UML package diagram for _Chirp!_.
