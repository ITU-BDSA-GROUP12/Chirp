...
For a more in depth visualization of which classes reside in which of the packages mentioned, see the PNG-file located at 'Chirp/docs/images/PackageDiagram.png', a complete UML package diagram for _Chirp!_.
